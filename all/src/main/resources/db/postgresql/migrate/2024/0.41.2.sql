...
alter table base.course_journals add name varchar(200);
alter table base.course_journals add en_name varchar(400);
alter table base.course_journals add begin_on date;
alter table base.course_journals add end_on date;
