...
create table base.tutor_majors (id bigint not null, staff_id bigint not null, major_id bigint not null, edu_type_id integer not null, level_id integer not null,remark varchar(255));
...
alter table base.staffs add tutor_type_id int4;
update base.staffs staff set tutor_type_id=(select t.tutor_type_id from base.teachers t where t.staff_id=staff.id);
...
alter table edu.execution_course_groups rename to executive_course_groups;
alter table edu.execution_plans rename to executive_plans;
alter table edu.execution_plan_courses rename to executive_plan_courses;
