...
alter table qos.clazz_eval_stats add constraint pk_h8wqs26f7nox4hxxmeysgu9dg primary key (id);
alter table qos.clazz_option_stats add constraint pk_e5xc6a79o9e9jy0bt1u5jlggu primary key (id);
alter table qos.clazz_question_stats add constraint pk_jvexmr1r8v9lufg2c5pytu4ih primary key (id);
alter table qos.clazz_question_type_stats add constraint pk_ra5b57hfxoooc3fhxsjwjvaxw primary key (id);
...
alter table qos.course_question_type_stats add constraint pk_i10vdqqnr9xaj2iisewid0bk primary key (id);
alter table qos.depart_eval_stats add constraint pk_p87qmm6ecwo7f9x37labrlk4y primary key (id);
alter table qos.depart_option_stats add constraint pk_89nq7529cf276w2rse26e7o5e primary key (id);
alter table qos.depart_question_stats add constraint pk_rb9fumol3wcl5lq2s5juodx7g primary key (id);
alter table qos.depart_question_type_stats add constraint pk_e7jgmh5la4dtdkb09j8efwfv5 primary key (id);
alter table qos.evaluate_results add constraint pk_sjln57t9wh1oadhcwy8aiagck primary key (id);
alter table qos.evaluation_criteria_items add constraint pk_9bwhbdtgm3l50net2pj95kuud primary key (id);
alter table qos.evaluation_criterias add constraint pk_1xhgb8vf873clpcmt2y2jm4j8 primary key (id);
...
alter table qos.question_types add constraint pk_pu79l75r4ir625277t7yvfhrk primary key (id);
...
alter table qos.school_option_stats add constraint pk_99wjyr6dx9xa1ped2kxl7rw94 primary key (id);
alter table qos.school_question_stats add constraint pk_n70j1ruso03xpdyj7snecifwk primary key (id);
alter table qos.school_question_type_stats add constraint pk_6dseebm5me7ji9mkaklhbvcjr primary key (id);
alter table qos.teacher_eval_stats add constraint pk_2g98u3v4fyg0lg3x0f5bs7yhq primary key (id);
alter table qos.teacher_option_stats add constraint pk_stbhs3picy1k3eko5h1vw7sip primary key (id);
alter table qos.teacher_question_stats add constraint pk_jvdgeq1a7ei8kvk3rsv6ikyvs primary key (id);
alter table qos.teacher_question_type_stats add constraint pk_l8vf7fpys3bu5jh2g4h7vw7ft primary key (id);
