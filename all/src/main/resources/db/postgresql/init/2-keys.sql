...
alter table flow.prac_ability_credit_applies add constraint pk_akcwbt40ex2cgciodo9eh10u0 primary key (id);
alter table flow.process_logs add constraint pk_pg4kxtmg5fqls4l221xt6b9cn primary key (id);
alter table flow.std_grad_bachelor2nd_applies add constraint pk_10ftvtv9d898ix5bwew7jrcwq primary key (id);
alter table flow.std_grad_complete_applies add constraint pk_sbn2jo3vksi0os7sw90rfps3y primary key (id);
alter table flow.std_grad_complete_applies add constraint uk_ngk5gkm4resrf5lqrltl7o7ls unique (batch_id,std_id);
alter table flow.std_grad_defer_applies add constraint pk_3e8khwunnbc8jray8c32nvnm9 primary key (id);
...
alter table std.grad_plan_result_checks add constraint pk_mni6l7r5c077341q1l6pb2rwy primary key (id);
alter table std.grad_plan_result_checks add constraint uk_972w0f0qttrqqnw8f0ergwvek unique (std_id);
