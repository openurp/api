...
create index idx_okhf1aowv2bfnakj4bilsgvhn on edu.clazz_option_stats (question_stat_id);
create index idx_r0vg6mq0l0isrk8taocrdqqx2 on edu.clazz_question_stats (eval_stat_id);
create index idx_ojrkhn0h6br5f6n6sj1dbpfk6 on edu.clazz_question_type_stats (eval_stat_id);
create index idx_2nu751wwcosaoh3kd2a36ycdj on edu.clazzes (group_id);
create index idx_erjg7aasw8glnxx3lrmvmrmqs on edu.clazzes (project_id, teach_depart_id);
...
create index idx_ge1xy7c75yebe89psnbqqnmmf on edu.course_option_stats (question_stat_id);
create index idx_nam6mb615mbrtiesoyruaqxom on edu.course_question_stats (eval_stat_id);
create index idx_ro9jt76eu2mm9o6595iaenuaw on edu.course_question_type_stats (eval_stat_id);
create index idx_cg1338egu7o03diaf8h2ebjvp on edu.course_takers (clazz_id);
create index idx_oglqawgw140uo18apeo7854pu on edu.depart_option_stats (question_stat_id);
create index idx_obashn99dymi92mf91b4nmvmg on edu.depart_question_stats (eval_stat_id);
create index idx_4mcmjt66f8q52ctg2c4p0as89 on edu.depart_question_type_stats (eval_stat_id);
create index idx_5nnh9us7gnoognmp5q2xg60p4 on edu.evaluation_criteria_items (criteria_id);
...
create index idx_pdwk4ip0w6d82jy0xiouegpaa on edu.exam_rooms_activities (exam_room_id);
...
create index idx_qc1efy1cyakxr3wtg16kilx7f on edu.exchange_grades (exchange_student_id);
create index idx_56xdm5a4qc9hqkj6rtm7ota1l on edu.exchange_grades_courses (exchange_grade_id);
...
create index idx_mejcmpe6sjv8ms3xcx67b8fvd on edu.factor_segments (factor_id);
...
create index idx_t5i75g36sonrbk0w7j22u885o on edu.lessons (clazz_id);
...
create index idx_f5kj6dxaq8tcasfuc6a1r4nv on edu.options (option_group_id);
...
create index idx_8bhmm2vgbinad1w0aylpxt4n7 on edu.question_results (result_id);
create index idx_1mhhdaxdan0vekgoofvqin7hk on edu.questionnaires_questions (questionnaire_id);
...
create index idx_by5qirmgdrj5x19jrufrm1ve9 on edu.school_option_stats (question_stat_id);
create index idx_f3igcqaja6fvjkdel9xeqk0ai on edu.school_question_stats (eval_stat_id);
create index idx_pt0fyb4lahxfp9j5or2ecqj0q on edu.school_question_type_stats (eval_stat_id);
...
create index idx_ojgk4b0hl2ks2hgw2l11ktdr9 on edu.teacher_option_stats (question_stat_id);
create index idx_7lykycmfk7vttwxwqw2hpr565 on edu.teacher_question_stats (eval_stat_id);
create index idx_9d7epkerdh0q4rrvvjrn7epth on edu.teacher_question_type_stats (eval_stat_id);
create index idx_8s9ak6mlyl39u6hp8j4ysbkel on edu.teacher_remessages (text_evaluation_id);
create index idx_gavh43lg9nulgrwrywxh9o76u on edu.teacher_remessages_students (teacher_remessage_id);
create index idx_aihl5k2oasyhg4xfdxmr2cicx on edu.teaching_loads_clazz_tags (teaching_load_id);
