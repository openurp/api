...
create index idx_4kdjyo3tkur49asbeyvr9jbl2 on degree.defense_groups_writers (defense_group_id);
...
create index idx_3satycdwhqn7ehiyxab4gh737 on degree.stage_times (plan_id);
...
create index idx_3sh68rf2rp0n9hopnqeiy150d on qos.cfg_assess_grades (criteria_id);
create index idx_fvhnd9gmt5vmdtqshm5jy9v00 on qos.cfg_options (group_id);
create index idx_r4mlhni3gr9ju28ca9o1iuw76 on qos.cfg_questionnaires_questions (questionnaire_id);
