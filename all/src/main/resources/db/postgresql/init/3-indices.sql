...
create index idx_mjovf6o248wptv3tnax2im4f5 on base.course_names (course_id);
...
create index idx_ns0l3ratqk1pjc9tmmvoxyxkc on code.course_general_types (parent_id);
