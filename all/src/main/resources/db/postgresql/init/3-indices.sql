...
create index idx_j7apofjpojyk6ehp8o88ol3dl on cfg.qos_assess_grades (criteria_id);
create index idx_t2ij4kmy5k10q4vmi147gp6r7 on cfg.qos_options (group_id);
create index idx_9sbcqw3wx3yk9u425byrmqnyn on cfg.qos_questionnaires_questions (questionnaire_id);
