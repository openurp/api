...
create index idx_o4jgkhrjid48d0wy0bhjkdca6 on base.teaching_offices_members (teaching_office_id);
...
create index idx_1fxnwy6amvnmnfj64pq6g2yhf on edu.execution_plan_courses_labels (execution_plan_course_id);
...
create index idx_2qj788gjlaycksx0rlsokpp75 on edu.major_plan_courses_labels (major_plan_course_id);
...
create index idx_p9a8tes5cdmax52ljdeq28u6f on edu.std_plan_courses_labels (std_plan_course_id);
...
create index idx_cxns1b6r5xfgotmjn6c5t7bv4 on prac.inno_closure_review_details (review_id);
create index idx_gcu5ec5e90o1aox3qxafr86v8 on prac.inno_closure_review_groups_experts (closure_review_group_id);
create index idx_g8pm4sw2n52eub826x1mvxup0 on prac.inno_init_review_details (review_id);
create index idx_6uvxtr1qlgqeq925k4sedsige on prac.inno_init_review_groups_experts (init_review_group_id);
create index idx_70t28qqsq33k71oq3jpjnr6il on prac.inno_level_jounals (project_id);
create index idx_g05wh2pyjqtqmc2rnv8i0xgg0 on prac.inno_materials (project_id);
create index idx_19l63lac8dylodhl4iutkxfwb on prac.inno_members (project_id);
create index idx_e8x1vw96ap0rqyeg35osytb2e on prac.inno_projects_instructors (project_id);
create index idx_3ej6gvsk5b1ve3iv29r655aww on prac.inno_stage_types (parent_id);
create index idx_tctfj7y4mytlshfxvmxnp5vw1 on prac.inno_stages (batch_id);
create index idx_3uf5664x1helu23hou8bnco83 on prac.lw_deadlines (writer_id);
create index idx_phoyqm5nn7w2kf00uxspcb2d8 on prac.lw_defense_groups_writers (defense_group_id);
create index idx_7mj6sipdjhxc6cj919qrnqdf1 on prac.lw_defense_members (group_id);
create index idx_bytwb33x78b6t64rv0f0b9byx on prac.lw_defense_notices (group_id);
create index idx_ay5lhmjbj6mp3qs7gi3f9mvp1 on prac.lw_midterm_check_details (check_id);
create index idx_b3g4yvjx6u8uyk8gsp3pdnaqi on prac.lw_stage_times (plan_id);
create index idx_p55637k8ahkffyxbwkkk2bjnd on prac.lw_subjects_majors (subject_id);
